...
# pecan Config
#
PRODUCT_SPECIFIC_DEFINES += TARGET_PRELINKER_MAP=device/lg/pecan/prelink-linux-arm.map
...
TARGET_PREBUILT_KERNEL := device/lg/pecan/kernel

BOARD_EGL_CFG := device/lg/pecan/egl.cfg
